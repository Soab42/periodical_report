...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function showTotalRow() {
    const totalRow = total_periodical_progress_information.reduce(
      (acc, curr) => {
        console.log(acc);
        ...
        acc.OTR_principal = checkInitialData(
          acc.OTR_principal,
          curr.OTR_principal
        );

        acc.PRA_priciple = checkInitialData(
          acc.PRA_priciple,
          curr.PRA_priciple
        ); // Check the typo in the original) lineacc.PRA_priciple,
